...
public class Automation_Assignment {
    public static void main(String[] args) {
        ...
        if(driver.getTitle().equals("Facebook - log in or sign up")) System.out.println("Page title validation is PASSED");
        ...
        if(header.getText().equals("Connect with friends and the world around you on Facebook."))
            System.out.println("Heading2 text validation is PASSED"); else
        ...
        WebElement loginButDisplayAndEnabled = driver.findElement(By.name("login"));
         ...
         if(forgetPassword.getText().equals("Forgot password?"))
             System.out.println("Forget password link match with the requirements is PASSED"); else
